...
public class CsvReportGeneratorTests : IDisposable
{
    ...
    public void Generate_WritesAllPackageRows()
    {
        ...
        var packages = new List<PackageEntry>
        {
            ...
            new("express", "4.18.2", "4.18.2", "my-api", "https://www.npmjs.com/package/express/v/4.18.2", "MIT", "2023-10-11", "4.21.0", "https://www.npmjs.com/package/express/v/4.21.0", "MIT", "2024-09-11"),
        };
    ...
    public void Generate_HandlesNullLicenseAndPublishedDate()
    {
        ...
        var packages = new List<PackageEntry>
        {
            new("some-pkg", "1.0.0", "1.0.0", "my-app", "https://example.com", null, null, null, null, null, null),
        };
    ...
    public void Generate_CsvRowFormat()
    {
        ...
        var packages = new List<PackageEntry>
        {
            new("test-pkg", "2.0.0", "2.0.0", "proj-x", "https://example.com", "Apache-2.0", "2024-01-15", "3.0.0", "https://example.com/latest", "Apache-2.0", "2024-06-01"),
        };
